# Unfrotunately, this wont work we dont have shapefiles but arcexport and
#  I dont know how to handel them. 
# Niklas Neiße, Nov. 15, 2024
...
# quadNames <- list.files(paste0(dat_dir, 'arcexport'))
