# plantTracker for adler 2007 kansas Aristida longiseta
...
# Read in species list, species name changes, 
 # and subset species list to perennial target_spec
# with minimum cover of 100. Also taking out Carex spp.; 
