...
ggsave(paste0("anderson_2016_mt/results/", sp_abb, "/years_lamda_mod_vs_obs.png"), 
       plot = mod_vs_obs,
...
write.csv(all_pars, 
          paste0("anderson_2016_mt/data/", sp_abb, "/all_pars.csv"), 
          row.names = F)
...
write.csv(lam_out, 
          paste0("anderson_2016_mt/data/", sp_abb, "/lambdas_yr_vec.csv"), 
          row.names = F)

lam_out_wide  <- as.list(pivot_wider(lam_out, names_from = "coefficient", 
                                     values_from         = "value"))
write.csv(lam_out_wide, 
          paste0("anderson_2016_mt/data/", sp_abb, "/lambdas_yr.csv"), 
          row.names = F)
