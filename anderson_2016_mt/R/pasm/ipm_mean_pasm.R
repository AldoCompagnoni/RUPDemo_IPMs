# IPM for alder 2007 & chu 2016; kansas; Bouteloua hirsuta
...
# source(paste0('anderson_2016_mt/R/', sp_abb, '/kansas_tracker_', sp_abb, '.R'))

## Read and clean the species data
df <- read.csv(paste0('anderson_2016_mt/data/', 
...
if (!dir.exists(paste0("anderson_2016_mt/results/", sp_abb))) {
  dir.create(paste0("anderson_2016_mt/results/", sp_abb))
}
# Save the inventory plot to a file
ggsave(paste0("anderson_2016_mt/results/", 
...
write.csv(df,      paste0("anderson_2016_mt/data/", sp_abb, "/data_df.csv"))
write.csv(surv_df, paste0("anderson_2016_mt/data/", sp_abb, "/survival_df.csv"))
write.csv(grow_df, paste0("anderson_2016_mt/data/", sp_abb, "/growth_df.csv"))
write.csv(recr_df, paste0("anderson_2016_mt/data/", sp_abb, "/recruitment_df.csv"))
...
ggsave(paste0("anderson_2016_mt/results/", sp_abb, "/overall_hist_sizes_log.png"), 
       plot = hist_sizes_log, 
...
ggsave(paste0("anderson_2016_mt/results/", sp_abb, "/overall_surv.png"), 
       plot = surv_overall, 
...
ggsave(paste0("anderson_2016_mt/results/", sp_abb, "/overall_gr.png"), 
       plot = gr_overall, 
       width = 4, height = 3, units = "in", dpi = 150)
...
ggsave(paste0("anderson_2016_mt/results/", sp_abb, "/overall_rec.png"), 
       plot = rec_overall, 
       width = 4, height = 3, units = "in", dpi = 150)
