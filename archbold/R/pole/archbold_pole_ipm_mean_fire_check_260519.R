...
mod_su_bestfit <- glm(survives ~ logvol_t0 + logvol_t0_2 + recruits + disturbance, 
...
mod_gr_bestfit       <- lm(logvol_t1 ~ logvol_t0 * recruits + logvol_t0_2 + disturbance, 
                           data = df_gr)
...
mod_fl_bestfit <- glm(flower ~ logvol_t0 + logvol_t0_2 + disturbance, 
...
mod_fl_n_bestfit <- glm.nb(fl_nr ~ logvol_t0 + logvol_t0_2 + logvol_t0_3 + disturbance, 
                           data = df_fl_cond)
