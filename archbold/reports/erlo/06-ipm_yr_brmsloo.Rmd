...
# LOO model selection
mod_su_name_bestfit <- rownames(mods_su_loo_compare)[1]
...
# LOO model selection
mod_gr_name_bestfit <- rownames(mods_gr_loo_compare)[1]
...
# LOO model selection
mod_do_name_bestfit <- rownames(mods_do_loo_compare)[1]
...
# LOO model selection
mod_ra_name_bestfit <- rownames(mods_ra_loo_compare)[1]
...
if (length(mods_fl_loo) > 1) {
  ...
  mod_fl_name_bestfit <- rownames(mods_fl_loo_compare)[1]
} else {
...
if (length(mods_fl_n_loo) > 1) {
  ...
  mod_fl_n_name_bestfit <- rownames(mods_fl_n_loo_compare)[1]
} else {
...
if (length(mods_re_loo) > 1) {
  ...
  mod_re_name_bestfit <- rownames(mods_re_loo_compare)[1]
} else {
