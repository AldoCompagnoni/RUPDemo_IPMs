# Yearly historical envi projection model with random disturbance slope in recruit model {#yr-ipm-hist-envi-re_dist_slope}
...
### Number of flowers to recruits transition
#### Flowering stems to recruits data
```{r}
...
df_transition_site <- df_disturbance_transition_site %>%
  ...
  dplyr::select(site, transition, p_transition) %>%
