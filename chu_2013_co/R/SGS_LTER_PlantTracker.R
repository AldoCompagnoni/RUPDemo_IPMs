...
drop_rows <- c(
  # 41226, 41252, 41258, 41324, 41330, 41502, 41602, 41645, 42148, 42336, 43659, 
  # 44177, 44285, 44376, 44593, 44756, 44778, 44847, 44892, 44894, 44962, 45351, 
  # 45515, 45559, 45652, 45682, 47282, 47496, 47577, 47904, 48020, 48378, 48764, 
  # 49028, 49057, 49097, 49159, 49341, 49370, 49440, 49603, 50608, 50703, 51166, 
  # 51175, 51377, 51402, 51557, 51683, 51849, 52111, 52454, 52457, 53041, 53448, 
  # 53449, 53471, 53523, 54208, 55464, 55764, 55872, 55905, 56139, 56314, 56496, 
  # 56826, 57085, 57086, 57156, 57183, 57508, 57766, 57850, 57975, 58194, 58795, 
  # 59964, 60244, 60261, 60906, 61559, 61957, 61962, 62564, 63315, 63419, 63736, 
  # 63739, 63764, 63808, 63809, 64229, 64320, 65145, 66132, 68407, 68586, 68878, 
  # 68922, 69033, 69300, 69315, 69401, 69827, 69983, 70051, 70375, 70435, 70468, 
  # 70470, 70493, 70503, 70552, 70663, 70912, 71118, 74592, 75064, 75067, 75433, 
  # 75800, 75962, 76001, 76473, 77872, 78722, 79486, 79550, 80555, 82966, 83268, 
  # 83403, 83447, 83746, 840
  )
...
saveRDS(dat02, file = paste0(dat_dir, "SGS_LTER_plantTracker_grasses_filtered.rds"))
