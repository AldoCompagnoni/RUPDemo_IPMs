# Populating padrino - chu 2013 colorado Buchloe dactyloides
...
# # overall imp 
# source(paste0(dir, '/R/', sp_abb, '/ipm_tracker_', sp_abb, '.R'))
...
pdb$Metadata[1,] <- c(
  ...
  'Buchloe_dactyloides', 'Buchloe_dactyloides', 'Buchloe',
