...
# Version 22: Added ability to define buffer size to account for different
...
v_size_threshold <- NULL # NULL to turn off minimum size threshold (keep impossibly small individuals)
