...
v_region_abb  <- c('id')
# Define species 
v_species     <- c('Pseudoroegneria spicata')
...
v_authors  <- c('Zachmann; Moffet; Adler')
...
v_doi      <- c('10.1890/10-0404.1')
# The last name of the corresponding author
v_corresponding_author <- c('Zachmann')
...
v_email_year <- c('lzachmann@gmail.com (2024)')
...
v_apa_citation <- c('Zachmann, L., Moffet, C., & Adler, P. (2010). Mapped quadrats in sagebrush steppe: long‐term data for analyzing demographic rates and plant–plant interactions: Ecological Archives E091‐243. Ecology, 91(11), 3427-3427..')
...
v_demog_appendix_link <- c('https://figshare.com/collections/Mapped_quadrats_in_sagebrush_steppe_long-term_data_for_analyzing_demographic_rates_and_plant_plant_interactions/3303612')
