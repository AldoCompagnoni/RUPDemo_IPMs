# Populating padrino - chu 2013 colorado Pseudoroegneria spicata
...
# 3.1 all_pars     : view(all_pars)
# 3.2 pars_var_wide: view(pars_var_wide)
# 3.3 lam_mean_ipmr: view(lam_mean_ipmr)
# 3.4 pdb          : view(pdb)
...
# Main code --------------------------------------------------------------------
source('helper_functions/padrino_year_specific.R')
